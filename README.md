...
* [webtorrent](https://github.com/webtorrent/webtorrent) ⭐ 31,415 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-19 – BitTorrent over WebRTC.
* [gun](https://github.com/amark/gun) ⭐ 19,137 | 🐛 321 | 🌐 JavaScript | 📅 2026-09-16 – A realtime, decentralized, offline-first, graph database engine.
* [websocketd](https://github.com/joewalnes/websocketd) ⭐ 17,469 | 🐛 1 | 🌐 Go | 📅 2026-09-07 – Turn any program that uses stdin/stdout into a WebSocket server.
...
* [torrent-stream](https://github.com/mafintosh/torrent-stream) ⭐ 1,975 | 🐛 91 | 🌐 JavaScript | 📅 2020-12-04 – The low level streaming torrent engine that peerflix uses.
...
* [hypercore](https://github.com/mafintosh/hypercore) ⭐ 2,914 | 🐛 59 | 🌐 JavaScript | 📅 2026-09-23 – A p2p network for distributing and replicating static feeds of binary data.
...
* [utp-native](https://github.com/mafintosh/utp-native) ⭐ 101 | 🐛 17 | 🌐 JavaScript | 📅 2024-09-03 – micro transport protocol, a network protocol similar to tcp that runs on top of udp.
